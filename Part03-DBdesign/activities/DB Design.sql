--Thiết kế ERD và DDL (SQL Server) để lưu trữ thông tin về các seminar,
--buổi giảng phụ đạo của các thầy cô bên bộ môn SE. 
 --  Mỗi giảng viên có thể tổ chức nhiều seminar/buổi phụ đạo khác nhau
 --và mỗi seminar/buổi phụ đạo chỉ do một giảng viên phụ trách  
  ...
  --chủ đề, tóm tắt nội dung, phòng học (nếu tiến hành offline), online-link
  --(nếu tiến hành online), sĩ số dự kiến

-- CHIẾN LƯỢC : GOM BẢNG 
-- XEM: ĐA TRỊ, COMPOSITE, LOOKUP, LẶP LẠI TRÊN 1 NHÓM CỘT 
--		TÁCH THÊM DÒNG TỐT HƠN CỘT(KHI CẦN THÊM DATA)
...
(
	LectID char(8),
	LectName nvarchar(30),   --composite, tách nếu ta muốn sort 
	Email varchar(50),
	Phone char(11),
	Major varchar(30),
	StartDate datetime,
	ActType nvarchar(30), --workshop, seminar, phụ đạo
	Topic nvarchar(30), -- Giới thiệu về arrtayList 
	Intro nvarchar(250),
	Room nvarchar(50), --lưu cái hyper link của Zoom, Meet, phòng 
	Seats int
)
...
INSERT INTO ACTIVITY_V1
	VALUES('00000001', N'HÒA.ĐNT', 'hoadnt@', '090x', 'CF', '2021-12-3 08:00:00', 'workshop',
			N'Giới thiệu về YOLO V4 (part 2)', N'...', N'Phòng seminar Thư viện FU HCM',100)
...
(
	...
	StartDate datetime,
	ActType nvarchar(30), --workshop, seminar, phụ đạo, COI TRỪNG GÕ WORKSHOP, KO AI CẤM GÕ CHỮ TRAINING 
						  --MÙI CỦA LOOKUP TÁCH BẢNG 
	Topic nvarchar(30), -- Giới thiệu về arrtayList 
	Intro nvarchar(250),
	Room nvarchar(50), --lưu cái hyper link của Zoom, Meet, phòng 
	Seats int,
...
INSERT INTO ACTIVITY_V2
	VALUES( '2021-12-3 08:00:00', 'workshop',
			N'Giới thiệu về YOLO V4 (part 2)', N'...', N'Phòng seminar Thư viện FU HCM',100,'00000001')
